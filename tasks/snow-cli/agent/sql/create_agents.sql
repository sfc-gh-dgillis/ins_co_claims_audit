  ...
  $$
{
  ...
  "instructions": {
    ...
    "sample_questions": [
      ...
      {
        "question": "Can you transcribe the media file 'ins_co_1899_call.wav' stored in '@ins_co.loss_claims.loss_evidence'?"
      },
      {
